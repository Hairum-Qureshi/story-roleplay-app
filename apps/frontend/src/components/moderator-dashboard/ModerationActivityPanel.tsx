            ...
            filteredReports.map((report) => (
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button className="rounded-lg border border-orange-400/30 bg-orange-500/10 px-3 py-2 text-xs font-medium text-orange-200 transition-colors hover:bg-orange-500/20">
                    Suspend
                  </button>
