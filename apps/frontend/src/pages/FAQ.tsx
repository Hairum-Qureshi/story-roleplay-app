			...
			<div className="max-w-4xl mx-auto px-6 py-10">
				...
				<div className="space-y-8">
					...
					<div>
						...
						<p className="text-lg">
							No, once you (or your role-play partner) clicks the 'End Role-Play' button, the action is
							permanent and cannot be undone. You will need to re-initiate a new
							role-play session if you wish to continue.
						</p>
					</div>
				</div>
			</div>
